function Friend(opt_options) {
  var options = opt_options || {};
  exports.Item.call(this, options);
}
exports.System.extend(Friend, exports.Item);

Friend.prototype._init = function(opt_options) {
  var options = opt_options || {};
  ...
  this.motorSpeed = typeof options.motorSpeed != 'undefined' ? options.motorSpeed : 2;
 ...
 */
Friend.degreesToRadians = function(degrees) {
  if (typeof degrees !== 'undefined') {
    return 2 * Math.PI * (degrees/360);
  } else {
    if (typeof console !== 'undefined') {
      console.log('Error: Friend.degreesToRadians is missing degrees param.');
    }
    return false;
  }
};
 ...
 */
Friend.radiansToDegrees = function(radians) {
  if (typeof radians !== 'undefined') {
    return radians * (180/Math.PI);
  } else {
    if (typeof console !== 'undefined') {
      console.log('Error: Friend.radiansToDegrees is missing radians param.');
    }
    return false;
  }
};
 ...
 */
Friend.prototype.step = function() {
  ...
  if (!this.velocity.mag()) {
    ...
    this.velocity.rotate(Friend.degreesToRadians(this.angle));
    this.velocity.mult(this.motorSpeed);
  }

  if (this.velocity.mag() > 0.1) {
    this.angle = Friend.radiansToDegrees(Math.atan2(this.velocity.y, this.velocity.x));
  }
 ...
 * @private
 */
Friend.prototype._seek = function(target) {
 ...
 */
Friend.prototype.getCSSText = function(props) {
